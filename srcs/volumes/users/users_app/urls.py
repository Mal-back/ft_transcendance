...
urlpatterns = [
        ...
        path('<str:username>/update_pic/', views.PublicUserUpdate.as_view(), name='user-update-avatar'),
        path('<str:username>/default_pic/', views.PublicUserSetDefaultAvatar.as_view(), name='user-defalt-avatar'),
