...
urlpatterns = [
        ...
        path('<str:username>/update/', views.PublicUserUpdateAvatar.as_view(), name='user-update-avatar'),
        path('<str:username>/update_pic/', views.PublicUserUpdate.as_view(), name='user-update'),
