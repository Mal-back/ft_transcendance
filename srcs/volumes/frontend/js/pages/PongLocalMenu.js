...
export default class extends AbstractView {
  constructor() {
    ...
    this.handleLocalGameRedirection = this.handleLocalGameRedirection.bind(this);
    this.handleLocalTournamentRedirection = this.handleLocalTournamentRedirection.bind(this);
  }
  ...
  async addEventListeners() {
    ...
    const remote = document.querySelector("#PongLocalTournamentButton");
    remote.addEventListener("click", this.handleLocalTournamentRedirection);
  }
  ...
  removeEventListeners() {
    ...
    const remote = document.querySelector("#PongLocalTournamentButton");
    remote.removeEventListener("click", this.handleLocalTournamentRedirection);
  }
