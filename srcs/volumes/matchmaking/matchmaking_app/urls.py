...
urlpatterns = [
        ...
        path('tournament/next_round/', views.LaunchNextRound.as_view() , name='tournament-next-round'),
        path('tournament/detail/', views.GetTournament.as_view(), name='tournament-detail'),
