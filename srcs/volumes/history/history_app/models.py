...
class TournamentUser(models.Model):
    username = models.ForeignKey(
        "MatchUser", related_name="user", on_delete=models.PROTECT, to_field="username"
    )
    ...
    tournament = models.ForeignKey(
        "Tournament", related_name="final_ranking", on_delete=models.CASCADE
    )


class Tournament(models.Model):
    game_type = models.TextField(
        choices=[("pong", "Pong"), ("c4", "Connect four")])
